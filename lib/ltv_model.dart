...
class LtvModel {
  ...
  BoundValue purchasesPerYear,
      year2PurchaseValue,
      year3PurchaseValue,
      year2PurchasesPerYear,
      year3PurchasesPerYear,
      year2RetentionRate,
      year3RetentionRate;

  // output values
  BoundValue suggestedRopoCoefficient,
      cpa,
      totalOnOffPurchase,
      totalPurchasePlusRepeat,
      referralAdditionalRevenue,
      totalPurchasePlusRepeatAndReferral,
      lifetimeValue,
      profitPerCustomer,
      roi,
      breakEvenCPC;
  ...
  void recalculate(Event e) {
    ...
    // first year
    num firstYearOnlinePurchase =
        firstPurchaseValue.value * purchasesPerYear.value;
    num firstYearTotalOnOffPurchase =
        firstYearOnlinePurchase * ropoCoefficient.value;

    // year 2
    num year2OnlinePurchase =
        year2PurchaseValue.value * year2PurchasesPerYear.value;
    num year2TotalOnOffPurchase =
        year2OnlinePurchase * year2RetentionRate.value * ropoCoefficient.value;
    num year2TotalDiscounted =
        year2TotalOnOffPurchase / (1 + costOfCapital.value);

    // year 3
    num year3OnlinePurchase =
        year3PurchaseValue.value * year3PurchasesPerYear.value;
    num year3TotalOnOffPurchase =
        year3OnlinePurchase * year3RetentionRate.value * ropoCoefficient.value;
    num year3TotalDiscounted =
        year3TotalOnOffPurchase / pow(1 + costOfCapital.value, 2);

    // year 4
    num year4PurchaseValue = year3OnlinePurchase;
    num year4RetentionRate = year3RetentionRate.value *
        ((customerLifetime.value - 1) / customerLifetime.value);
    num year4TotalOnOffPurchase =
        year4PurchaseValue * year4RetentionRate * ropoCoefficient.value;
    num year4TotalDiscounted =
        year4TotalOnOffPurchase / pow(1 + costOfCapital.value, 3);

    // year 5
    num year5PurchaseValue = year3OnlinePurchase;
    num year5RetentionRate = year4RetentionRate *
        ((customerLifetime.value - 1) / customerLifetime.value);
    num year5TotalOnOffPurchase =
        year5PurchaseValue * year5RetentionRate * ropoCoefficient.value;
    num year5TotalDiscounted =
        year5TotalOnOffPurchase / pow(1 + costOfCapital.value, 4);
    ...
    num sumOfAllOtherYearsTotalDiscounted = allOtherYearsTotalOnOffPurchase /
        (costOfCapital.value -
            (((customerLifetime.value - 1) / customerLifetime.value) - 1)) /
        pow(1 + costOfCapital.value, 5);

    // total
    totalPurchasePlusRepeat.value = firstYearTotalOnOffPurchase +
        year2TotalDiscounted +
        year3TotalDiscounted +
        year4TotalDiscounted +
        year5TotalDiscounted +
        sumOfAllOtherYearsTotalDiscounted;
    referralAdditionalRevenue.value =
        totalPurchasePlusRepeat.value * (1 / (1 - referralRate.value)) -
            totalPurchasePlusRepeat.value;
    totalPurchasePlusRepeatAndReferral.value =
        totalPurchasePlusRepeat.value + referralAdditionalRevenue.value;
    lifetimeValue.value =
        totalPurchasePlusRepeatAndReferral.value * grossMargin.value;
  ...
  void start() {
    ...
    year3RetentionRate.autoGetValue = () {
      return (customerLifetime.value - 1) /
          customerLifetime.value *
          (customerLifetime.value - 1) /
          customerLifetime.value;
    };
  ...
  void _setInputs(Map map) {
    ...
    if (map.containsKey("purchasesPerYear"))
      purchasesPerYear.elValue = map["purchasesPerYear"];
    if (map.containsKey("year2PurchaseValue"))
      year2PurchaseValue.elValue = map["year2PurchaseValue"];
    if (map.containsKey("year3PurchaseValue"))
      year3PurchaseValue.elValue = map["year3PurchaseValue"];
    if (map.containsKey("year2PurchasesPerYear"))
      year2PurchasesPerYear.elValue = map["year2PurchasesPerYear"];
    if (map.containsKey("year3PurchasesPerYear"))
      year3PurchasesPerYear.elValue = map["year3PurchasesPerYear"];
    if (map.containsKey("year2RetentionRate"))
      year2RetentionRate.elValue = map["year2RetentionRate"];
    if (map.containsKey("year3RetentionRate"))
      year3RetentionRate.elValue = map["year3RetentionRate"];
